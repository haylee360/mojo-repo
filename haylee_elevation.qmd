...
K3 <- ggplot(during_data, aes(x = date, y = k)) + 
  geom_smooth(span = 0.15, alpha = 0.001, 
...
# After Potassium line plot
K4 <- ggplot(after_data, aes(x = date, y = k)) + 
  geom_smooth(span = 0.15, alpha = 0.001, 
              aes(color = elevation_binned), 
              linewidth = 0.5, na.rm = TRUE) +
...
N3 <- ggplot(during_data, aes(x = date, y = no3_n)) + 
  geom_smooth(span = 0.15, alpha = 0.001, 
              aes(color = elevation_binned), 
              linewidth = 0.5, na.rm = TRUE) +
  scale_color_brewer(palette = "Dark2") +
...
# This one doesn't work with Loess in smooth
# Too many NAs in nitrate in the selected dates
# After Nitrate line plot
ggplot(after_data, aes(x = date, y = no3_n)) + 
  geom_point(aes(color = elevation_binned)) +
  # geom_smooth(span = 0.4, alpha = 0.001, 
  #             aes(color = elevation_binned), 
  #             linewidth = 0.5, na.rm = TRUE) +
